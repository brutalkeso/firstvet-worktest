import { StyleSheet, ActivityIndicator, View, Text, TouchableOpacity, StyleProp, ViewStyle } from "react-native"
...
function ErrorComponent({ retry, style }: { retry: () => void, style?: StyleProp<ViewStyle> }) {
    return (
        <View>
            <View style={[styles.wrapper, style]}>
                <Text style={styles.title}>Something went wrong</Text>
                <Text style={styles.description}>Unable to fetch questions, please try again later.</Text>
            </View>
